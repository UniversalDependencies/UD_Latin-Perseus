...
Latin Dependency Treebank (LDT) from the Perseus Project
...
The first conversion of LDT to Universal Dependencies was published in HamleDT 3.0
...
The HamleDT conversion is based on LDT version 1.5.
Two of the smaller files were taken as
development and test data respectively:
dev .... 1999.02.0055.xml ... Vergilius (Aeneid)
test ... 1999.02.0029.xml ... Ovidius (Metamorphoses)
